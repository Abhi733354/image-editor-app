...
const ImageEditor = ({ imageUrl }) => {
    ...
    return (
        <div className="container vh-100  mt-4 border p-4 rounded">
            ...
            <div className="d-flex flex-column align-items-center">
                <div className="controls my-3">
                    ...
                    <button className="btn btn-warning me-2" onClick={() => addShape('triangle')}>Add Triangle</button>
                    <button className="btn btn-info" onClick={downloadImage}>Download Image</button>
                </div>
            </div>
